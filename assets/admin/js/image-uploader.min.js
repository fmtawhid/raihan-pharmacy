!(function ($) {
  ...
  $.fn.fileUploader = function (options) {
    ...
    const defaults = {
      ...
      extensions: ['.jpg', '.jpeg', '.png', '.webp'], // Accepted file extensions.
      mimes: ['image/jpeg', 'image/png', 'image/webp', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/pdf', 'text/plain', 'audio/mpeg', 'audio/wav', 'audio/ogg', 'video/mp4', 'video/webm'], // Accepted MIME types.
