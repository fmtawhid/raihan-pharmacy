                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button"
                                                ...
                                                data-id="{{ $category->id }}"
                                                data-action="{{ route('admin.category.force-delete', $category->id) }}"
                                                data-question="@lang('Are you sure to permanently delete this category?')">
                                                <i class="las la-trash"></i> @lang('Permanent Delete')
                                            </button>
                                            <button type="button"
                                                class="btn btn-sm btn-outline--primary confirmationBtn"
                                                data-id="{{ $category->id }}"
