...
class CartController extends Controller
{
    ...
    public function cart()
    {
        ...
        return view('Template::cart', compact('pageTitle', 'cartData', 'subtotal', 'productCategories', 'shippingMethods', 'gatewayCurrencies', 'shippingMethod', 'hasPhysicalProduct', 'coupon'))
            ->with('cartItemCount', $this->cartItemsCount())
            ->with('partialCartData', $this->partialCart());
    }
