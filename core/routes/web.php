...
// All Deals
    Route::get('/deals', [SiteController::class,'allDeals'])->name('multi_express.deal.index');
    Route::get('/deals/category/{id}', [SiteController::class,'dealsByCategory'])->name('multi_express.deal.by_category');

    // Single Deal
    Route::get('/deal/{id}', [SiteController::class,'showDeal'])->name('multi_express.deal.show');
    Route::post('/deal/{deal}/join', [SiteController::class, 'joinDeal'])
    ->name('multi_express.deal.join');