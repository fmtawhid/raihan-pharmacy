                                    ...
                                    <tr>
                                            ...
                                            <div class="d-flex flex-wrap flex-md-nowrap gap-2 justify-content-lg-start justify-content-end">
                                                ...
                                                <div class="table-thumb">
                                                    <a href="{{ $product->mainImage() }}" class="image-popup">
                                                        <img src="{{ $product->mainImage(false) }}" alt="@lang('image')">
                                                    </a>
                                                </div>
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap flex-md-nowrap justify-content-end gap-1">
                                                @if ($trashed)
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline--danger confirmationBtn flex-shrink-0"
                                                        data-action="{{ route('admin.products.force-delete', $product->id) }}"
                                                        data-question="@lang('Are you sure to permanently delete this product?')">
                                                        <i class="las la-trash"></i>@lang('Permanent Delete')
                                                    </button>
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline--success confirmationBtn flex-shrink-0"
                                                        data-action="{{ route('admin.products.delete', $product->id) }}"
                                                        data-question="@lang('Are you sure to restore this product?')">
                                                        <i class="las la-trash-restore"></i>@lang('Restore')
                                                    </button>
                                                @else
                                                    @if($admin->can('edit_products'))
                                                    <a href="{{ $product->editUrl() }}" class="btn btn-outline--primary flex-shrink-0">
                                                        <i class="la la-pencil"></i>@lang('Edit')
                                                    </a>
                                                    @endif
                                                    @if($admin->can('delete_products'))
