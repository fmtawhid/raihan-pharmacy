...
<div class="banner-container @if (gs('homepage_layout') == 'full_width_banner') single-banner @endif"  style="margin-top:-19px;">
    <div class="hero-section mb-60">
        ...
        <div class="hero-banner">
            <a href="{{ @$content->data_values->fixed_banner_link }}" class="d-inline"><img class="w-100 h-100"
                    src="{{ frontendImage('banner', @$content->data_values->fixed_banner, '300x510') }}" alt=""></a>
        </div>
        @endif
    </div>
</div>
