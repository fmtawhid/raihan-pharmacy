...
function getSessionId()
{
     ...
     session()->put('session_id', $hash); // Store it in session
     return $hash;
}
...
if (!function_exists('guestCheckoutEnabled')) {
    /**
     * Returns true when the “Allow Guest Checkout” toggle is ON
     */
    function guestCheckoutEnabled(): bool
    {
        return (bool) (gs()->allow_guest_checkout ?? false);
    }
}